...
app.get("/jobs/:search", async (req, res) => {
  ...
  if (search === "all") {
    const getAllJobs = "SELECT * FROM jobs JOIN companies ON jobs.account_id = companies.account_id"
    ...
    const getJobs =
      "SELECT * FROM jobs JOIN companies ON companies.account_id = jobs.account_id WHERE job_title LIKE $1 OR company_name LIKE $1"
